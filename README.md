...
开始游戏 狼人=xxx,村民=xxx,猎人=xxx，预言家=xxx(如果没有就输0)  
结束狼人杀  
...
## 接入bot完成，开始修bug
### （23：10）
## 修复了部分bug(stage3 v2.1)
# Day7
## 修复了狼人杀的若干bug，并增加了一些必要的输出（stage3 v3.0）
似乎可以正常游戏了（？
# Day8
### (10:27)
## 终于！
## bot可以正常游玩了(stage3 v4.0)
命令如下：  
开始狼人杀-建房 房号=xxxx,人数=xxxx,昵称=xxxx
开始狼人杀-加房 房号=xxxx,昵称=xxxx
开始游戏 狼人=xxx,村民=xxx,猎人=xxx，预言家=xxx(如果没有就输0)（房间建好后）  
操作=xxx (输入游戏中的玩家id,功能有：投票、猎人开枪、狼人刀人、预言家的询问)
结束狼人杀  
在群聊中直接发送命令或者私聊bot发命令效果相同  
公共消息直接发到指定的群里，而身份消息等则会私聊  
游戏阶段有：werewolf,prophet,hunter,vote  
每个游戏阶段bot都会发送相应的通知和当前存活的玩家名单  
游戏结束后会显示游戏结果，房主可以选择开始游戏或者结束狼人杀  

## 新增了被ban的用户尝试发消息时的提示功能（stage3 v4.1）
